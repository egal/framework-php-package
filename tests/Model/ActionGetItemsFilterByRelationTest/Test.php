...
namespace Egal\Tests\Model\ActionGetItemsFilterByRelationTest;
...
use Egal\Tests\Model\ActionGetItemsFilterByRelationTest\Models\Category;
use Egal\Tests\Model\ActionGetItemsFilterByRelationTest\Models\Product;
...
class Test extends TestCase
{
     ...
     * @param class-string|Closure $expect
     */
    public function test(array $filter, string|Closure $expect)
    {
        $this->seedData();
